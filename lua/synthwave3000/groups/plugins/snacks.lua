local function build(p, o)
	...
	return {
		SnacksNormal = { fg = p.fg, bg = bg_dark },
		SnacksNormalNC = { fg = p.fg, bg = bg_dark },
		SnacksWinBar = { fg = p.fg, bg = bg_dark },
		SnacksWinBarNC = { fg = p.fg_dim, bg = bg_darker },
		...
		SnacksPickerPickWin = { bg = p.green },
		SnacksPickerPickWinCurrent = { bg = p.orange_bright },
